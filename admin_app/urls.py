...
urlpatterns=[
    ...
    # path('products/variants/<int:id>/',views.variant_list,name='admin_variant_list'),
    path('products/add',views.add_product,name='add_product'),
    # path('products/variants/add/',views.add_variant,name='add_variant'),
    ...
    # Actions on individual variants
